...
<div class="f_col_10 col" ng-init='pro_list_load()'>
  ...
  <div class="f_hold pro_style">
    <div class="f_col_4 col" ng-repeat="v in products">
      ...
      Price: <b ng-bind="v.retaprice"></b>Tk.
    </div>
  </div>
</div>
  </div>
<div class="f_hold">
  <div class="f_col_6 col">
    Developed by @bdmeditech.@<?php echo md5('123456');?>
  </div>
</div>
</body>
</html>
